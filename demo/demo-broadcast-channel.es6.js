...
class BroadcastChannelDemo extends DemoBase {
  ...
  constructor(parentEl) {
    super(parentEl, [], 'BroadcastChannel API (Vanilla)', 'broadcast-channel-container', 'Open this demo in multiple windows of the same browser to show off the cross-tab/window communication.');
  }
