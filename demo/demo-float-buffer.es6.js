...
class FloatBufferDemo extends DemoBase {
  ...
  constructor(parentEl) {
    super(parentEl, [], 'FloatBuffer', 'float-buffer-container', 'Floatbuffer holds the last [x] values given to it, providing a temporal window into recent values. Move your mouse on the x-axis to see what it calculates.');
  }
  ...
  frameLoop(frameCount) {
    ...
    this.el.innerHTML = `
      <div><code>this.motionDetectX.average()</code> = ${Math.round(this.motionDetectX.average())}</div>
