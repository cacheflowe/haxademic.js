...
class PixiStageWebcamSquareDemo extends DemoBase {
  ...
  constructor(parentEl) {
    ...
    ], 'PixiStage | Webcam Square', 'pixi-stage-webcam-square', 'Click to start the camera, then click to download an image.');
  }
  ...
  initWebcam() {
    this.webcam = new Webcam((videoEl) => {
      ...
      this.pixiStage = new PixiStage(this.el, 0xffff0000, 'pixi', 1, {width:1024, height:1024});
...
if(window.autoInitDemo) window.demo = new PixiStageWebcamSquareDemo(document.body);
