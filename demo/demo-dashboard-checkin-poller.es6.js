...
import DashboardCheckinPoller from '../src/dashboard-checkin-poller.es6.js';
...
class DashboardCheckinPollerDemo extends DemoBase {
  ...
  init() {
    this.dashboardCheckin = new DashboardCheckinPoller('http://localhost/haxademic/www/dashboard-new/', 'test-app-web', "Test Web App", 10 * 1 * 1000);
