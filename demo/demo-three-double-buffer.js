...
import ThreeScenePlane from "../src/three-scene-plane.js";
import ThreeDoubleBuffer from "../src/three-double-buffer.js";
...
class ThreeDoubleBufferDemo extends DemoBase {
  constructor(parentEl) {
    super(
      parentEl,
      [],
      "ThreeScene | ThreeDouble Buffer",
      "three-scene-double-buffer",
      "A basic double buffer helper.",
      false
    );
  }
      ...
      uniforms: {
        ...
        res: {
          ...
          value: new THREE.Vector2(
            this.threeScene.getWidth(),
            this.threeScene.getHeight()
          ),
        },
        time: { type: "f", value: 0 },
        zoom: { type: "f", value: 1 },
  ...
  frameLoop(frameCount) {
    ...
    for (let i = 0; i < 5; i++) {
      ...
      this.doubleBuffer.setUniform(
        "rotation",
        _frameLoop.osc(0.01, -0.001, 0.001)
      );
