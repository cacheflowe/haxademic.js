...
class FrameLoopDemo extends DemoBase {
  ...
  initPointerPos() {
    ...
    this.outputTextSpecificPosxNorm = document.getElementById('specific-pos-x-percent');
    this.outputTextSpecificPosyNorm = document.getElementById('specific-pos-y-percent');
    this.outputTextSpecificInside = document.getElementById('specific-pos-inside');
  ...
  frameLoop(frameCount) {
    ...
    this.outputTextPosxNorm.innerHTML = (this.pointerPos.xNorm()+"").substr(0,4);
    this.outputTextPosyNorm.innerHTML = (this.pointerPos.yNorm()+"").substr(0,4);
    ...
    this.outputTextSpecificPosxNorm.innerHTML = (this.pointerPos.xNorm(this.specificEl)+"").substr(0,4);
    this.outputTextSpecificPosyNorm.innerHTML = (this.pointerPos.yNorm(this.specificEl)+"").substr(0,4);
