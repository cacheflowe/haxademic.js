...
class PixiStageTexturedMeshDemo extends DemoBase {
  ...
  init() {
    ...
    this.pixiContainer = document.getElementById('pixi-stage-textured-mesh-container');
...
if(window.autoInitDemo) window.demo = new PixiStageTexturedMeshDemo(document.body);
